...
class ResNet_RM_Hash(nn.Module):
    '''
    resnet18_RM_res5-8 and resnet34_RM_res8-16
    '''
    def __init__(self,model_name,theta_interval = 0,pretrained= True,classes = 8,hash_bit=16,dropout = 0.,device = 'cuda'):
        super(ResNet_RM_Hash,self).__init__()
...
if __name__ == "__main__":
    model = ResNet_RM_Hash(model_name='resnet34',theta_interval=90,pretrained=True).cuda()
